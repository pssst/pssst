 ...
 */
public final class Push extends Activity implements View.OnClickListener {
    /**
     * Sets up activity.
     ...
     * @author Christian & Christian
     */
    public final class PushTask extends TaskBase<String, Void> {
        /**
        ...
        protected final void onFinished(boolean error, Void v) {
            if (error) {
                ...
                finish();
                showNotice(getResources().getString(R.string.notice_message_pushed));
            }
        }
    }
}
